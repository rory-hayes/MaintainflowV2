-- Maintain Flow business-evals foundation.
-- Additive and rerunnable: preserves the legacy endpoint assurance tables while
-- introducing immutable browser-journey definitions and service-issued runs.
