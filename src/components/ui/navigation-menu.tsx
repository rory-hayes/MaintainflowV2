...
const navigationMenuTriggerStyle = cva(
  "group/navigation-menu-trigger cursor-pointer inline-flex h-9 w-max items-center justify-center rounded-full bg-transparent px-4 py-2 text-sm font-medium transition-all outline-none hover:bg-primary/20 focus:bg-primary/20 focus-visible:ring-3 focus-visible:ring-ring/50 focus-visible:outline-1 disabled:pointer-events-none disabled:opacity-50 data-popup-open:bg-primary/20 data-popup-open:hover:bg-primary/20 data-open:bg-primary/20 data-open:hover:bg-primary/20 data-open:focus:bg-primary/20"
)
